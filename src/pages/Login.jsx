            ...
            <div className="container flex flex-col items-center justify-center max-w-6xl gap-10 mx-auto md:flex-row">
                ...
                <div className="flex flex-col w-full max-w-md gap-10 md:w-1/2">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <span className="text-2xl font-semibold text-zinc-900 font-lexend">
                            CRM
                        </span>
                    </div>
                    ...
                    {/* Welcome */}
                    <div>
                        <h2 className="text-3xl font-semibold text-zinc-900 font-lexend">
                            Welcome 👋
                        </h2>
                        <p className="text-base font-light text-zinc-400 font-lexend">
                            Please login here
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-light text-zinc-900 font-lexend">
                                    Remember Me
                                </span>
                            </div>
                            <button
                        ...
                        <div className="flex items-center my-6">
                            ...
                            <div className="mx-4 text-sm text-gray-500 font-lexend">
                                OR
                            </div>
                            <div className="flex-1 border-t border-gray-300"></div>
                        </div>
                        ...
                        <div className="p-4 mt-6 border border-blue-200 rounded-lg bg-blue-50">
                            <h4 className="mb-2 font-semibold text-blue-800 font-lexend">
                                Demo Accounts:
                            </h4>
                            <div className="space-y-1 text-sm text-blue-700 font-lexend">
                                ...
                                <div>
                                    ...
                                    accounting@demo.com / password123
                                </div>
                            </div>
                        </div>
                    </form>
