                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-zinc-600 font-lexend">
                                        Manage company crypto assets and wallet
                                        connections
                                    </p>
                                </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                {connected ? (
                                    <div className="flex items-center gap-2 px-3 py-2 border border-green-200 rounded-lg bg-green-50">
                                        ...
                                        <span className="text-sm font-medium text-green-700 font-lexend">
                                            Connected
                                        </span>
                                    </div>
                                ) : (
                                    <WalletSelector className="text-sm" />
                                )}
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-6 mb-6 lg:grid-cols-2">
                            ...
                            <div className="p-6 bg-white border border-gray-200 rounded-lg">
                                ...
                                <div className="flex items-center gap-2 text-sm">
                                    <span className="text-green-600 font-lexend">
                                        +5.2%
                                    </span>
                            ...
                            <div className="p-6 bg-white border border-gray-200 rounded-lg">
                                ...
                                <div className="space-y-3">
                                    ...
                                    >
                                        ...
                                        <span className="font-medium text-indigo-700 font-lexend">
                                            Deposit Funds
                                        </span>
                                    </button>
                                    ...
                                    >
                                        ...
                                        <span className="font-medium text-green-700 font-lexend">
                                            Process Payroll
                                        </span>
                                    </button>
                                </div>
                                        ...
                                        >
                                            <div className="flex items-center justify-between mb-3">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div
                                                        className={`text-sm font-medium ${color} font-lexend`}
                                                    >
                                                        {symbol}
                                                    </div>
                                                </div>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <ul className="mt-2 space-y-1 text-sm text-yellow-700 font-lexend">
                                        <li>
                                            • Enable multi-signature for
                                            transactions above $10,000
                                        </li>
                                        <li>
                                            • Regular backup of wallet recovery
                                            phrases
                                        </li>
                                        <li>
